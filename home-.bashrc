...
export PS1="$(if [[ ${EUID} == 0 ]]; then if [[ "$HOME" == /root ]]; then echo '\[\033[01;31m\]\h'; else echo '\[\033[01;36m\]\h'; fi else echo '\[\033[00;32m\]\u\[\033[00;31m\]@\[\033[00;31m\]\h'; fi)\[\033[00;34m\] \w \$([[ \$? != 0 ]] && echo \"\[\033[01;31m\]:(\[\033[01;34m\] \")\$\[\033[00m\] "
